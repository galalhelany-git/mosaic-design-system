...
(() => {
  ...
  var theming_default = __STORYBOOK_THEMING__, { CacheProvider, ClassNames, Global, ThemeProvider, background, color, convert, create, createCache, createGlobal, createReset, css, darken, ensure, getPreferredColorScheme, ignoreSsrWarning, isPropValid, jsx, keyframes, lighten, srOnlyStyles, srOnlyUnsetStyles, styled, themes, tokens, typography, useTheme, withTheme } = __STORYBOOK_THEMING__;

  // ../../node_modules/.pnpm/@storybook+addon-docs@10.6.0_@types+react-dom@19.3.0_@types+react@19.3.0__@types+react@_c1ec27f37e4e8c385e6fdeb843118a8c/node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-Q6BGOKFZ.js
  var SNIPPET_WARNING_LABEL = "Incomplete code snippet", WarningButton = styled(Button)(({ theme }) => ({
  ...
  })), SnippetWarning = ({ warning, className }) => warning?.trim() ? react_default.createElement(
    WarningButton,
    {
      className,
    ...
    react_default.createElement(AlertIcon, null)
  ) : null;
  function _extends() {
...
`
  ...
  var curriedTransparentize = curry(transparentize), curriedTransparentize$1 = curriedTransparentize, Wrapper = styled.div(withReset, ({ theme }) => ({
    ...
    let highlighter = react_default.createElement(
      ...
      code
    ), syntaxHighlighter = warning ? react_default.createElement(SourceWrapper, null, highlighter, react_default.createElement(PositionedSnippetWarning, { warning })) : highlighter;
    if (typeof dark > "u")
  ...
  var manager_api_default = __STORYBOOK_API__, { ActiveTabs, Consumer, ManagerContext, Provider, RequestResponseError, Tag, addons, combineParameters, controlOrMetaKey, controlOrMetaSymbol, eventMatchesShortcut, eventToShortcut, experimental_MockUniversalStore, experimental_UniversalStore, experimental_getStatusStore, experimental_getTestProviderStore, experimental_requestResponse, experimental_useStatusStore, experimental_useTestProviderStore, experimental_useUniversalStore, getService, internal_checklistStore, internal_fullStatusStore, internal_fullTestProviderStore, internal_universalChecklistStore, internal_universalStatusStore, internal_universalTestProviderStore, isMacLike, isShortcutTaken, keyToSymbol, merge, mockChannel, optionOrAltSymbol, registerService, shortcutMatchesShortcut, shortcutToAriaKeyshortcuts, shortcutToHumanString, types, useAddonState, useArgTypes, useArgs, useChannel, useGlobalTypes, useGlobals, useParameter, useServiceCommand, useServiceQuery, useSharedState, useStoryPrepared, useStorybookApi, useStorybookState } = __STORYBOOK_API__;
...
`);
  ...
  var ADDON_ID = "storybook/docs", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "docs";
  var SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`, SourceType = ((SourceType2) => (SourceType2.AUTO = "auto", SourceType2.CODE = "code", SourceType2.DYNAMIC = "dynamic", SourceType2))(SourceType || {});
  ...
  // ../../node_modules/.pnpm/@storybook+addon-docs@10.6.0_@types+react-dom@19.3.0_@types+react@19.3.0__@types+react@_c1ec27f37e4e8c385e6fdeb843118a8c/node_modules/@storybook/addon-docs/dist/manager.js
  var CodePanel = ({
    active,
    lastEvent,
    currentStoryId,
    ...
    useEffect(() => {
      ...
      {
        [SNIPPET_RENDERED]: ({ id, source, format: format2, warning: warning2 }) => {
          id !== void 0 && id !== currentStoryId || setSourceCode({ source, format: format2, warning: warning2 });
        }
      },
      [currentStoryId]
    );
    ...
    return react_default.createElement(AddonPanel, { active: !!active }, react_default.createElement(SourceStyles, null, react_default.createElement(Source, { ...parameter.source, code, format: codeSnippet.format, dark: isDark }), react_default.createElement(PositionedSnippetWarning2, { warning })));
  };
  ...
  }), PositionedSnippetWarning2 = styled(SnippetWarning)({
    position: "absolute",
    top: 8,
    right: 10
  });
