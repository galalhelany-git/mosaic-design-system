...
import { St as require_memoizerific, _t as _objectWithoutPropertiesLoose, bt as useCopyButton, vt as ActionBar, wt as _extends, xt as styled, yt as ScrollArea2 } from "./blocks-GqmD_-gH.js";
import { H as __toESM$1, z as __commonJS } from "./docs-tools-DUQ2lcOy.js";
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-UAYGIC3L.js
function _typeof(o) {
...
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/syntaxhighlighter-4REYKNEV.js
...
var import_core = __toESM$1(require_core());
...
var ReactSyntaxHighlighter = SyntaxHighlighter;
...
} : {}, ({ showLineNumbers }) => showLineNumbers ? { ".react-syntax-highlighter-line-number::before": { content: "attr(data-line-number)" } } : {});
var UnstyledScroller = ({ children, className }) => import_react.createElement(ScrollArea2, {
	horizontal: !0,
	vertical: !0,
	focusable: !0,
	className
...
var wrapRenderer = (renderer, showLineNumbers) => showLineNumbers ? renderer ? ({ rows, ...rest }) => renderer({
	rows: rows.map((row) => processLineNumber(row)),
	...rest
}) : defaultRenderer2 : renderer;
var SyntaxHighlighter2 = ({ children, language = "jsx", copyable = !1, bordered = !1, padded = !1, format = !0, formatter = void 0, className = void 0, showLineNumbers = !1, ...rest }) => {
	...
	return import_react.createElement(Wrapper, {
		...
		showLineNumbers,
		className
	}, import_react.createElement(Scroller, null, import_react.createElement(ReactSyntaxHighlighter, {
