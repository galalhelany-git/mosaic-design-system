...
import { Tt as getControlId, ft as Button, gt as MarkupIcon, mt as PopoverProvider, pt as Form, xt as styled } from "./blocks-GqmD_-gH.js";
import { r as __toESM$1, t as __commonJS } from "./chunk-UAWMPV5J-CHw1Fl23.js";
//#region ../../node_modules/.pnpm/@storybook+addon-docs@10.6.0_@types+react-dom@19.3.0_@types+react@19.3.0__@types+react@_c1ec27f37e4e8c385e6fdeb843118a8c/node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6AOWCN3U.js
...
var import_color_convert = __toESM$1(require_color_convert(), 1);
...
var m = import_react.memo(function(o2) {
...
var T = import_react.memo(function(r2) {
...
var SwatchColor = styled(Button)(({ value, selected, theme }) => ({
	width: 16,
	height: 16,
...
var ColorSpace = /* @__PURE__ */ ((ColorSpace2) => (ColorSpace2.RGB = "rgb", ColorSpace2.HSL = "hsl", ColorSpace2.HEX = "hex", ColorSpace2))(ColorSpace || {});
...
var usePresets = (presetColors, currentColor, colorSpace, maxPresetColors = 27) => {
	...
	let presets = (0, import_react.useMemo)(() => {
		...
		if (maxPresetColors === 0 || maxPresetColors === 1 / 0) return combined;
...
var ColorControl = ({ name, storyId, controlsId, value: initialValue, onChange, onFocus, onBlur, presetColors, maxPresetColors, startOpen = !1, argType, required }) => {
	let { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, (0, import_react.useCallback)(debounce(onChange, 200), [onChange])), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace, maxPresetColors), Picker = ColorPicker[colorSpace], readOnly = !!argType?.table?.readonly, controlId = getControlId(name, storyId, controlsId);
