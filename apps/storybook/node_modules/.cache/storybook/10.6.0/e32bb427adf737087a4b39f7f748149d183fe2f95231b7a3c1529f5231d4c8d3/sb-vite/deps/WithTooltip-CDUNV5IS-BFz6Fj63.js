...
import { t as require_react_dom } from "./react-dom-tH90zLcV.js";
import { Ct as lightenColor, St as require_memoizerific, _t as _objectWithoutPropertiesLoose, wt as _extends, xt as styled } from "./blocks-GqmD_-gH.js";
import { t as require_client_logger } from "./storybook_internal_client-logger.js";
import { t as require_global } from "./@storybook_global.js";
import { H as __toESM$1, z as __commonJS } from "./docs-tools-DUQ2lcOy.js";
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/WithTooltip-CDUNV5IS.js
...
var useIsomorphicLayoutEffect = typeof window < "u" && window.document && window.document.createElement ? import_react.useLayoutEffect : import_react.useEffect;
var top = "top";
var bottom = "bottom";
var right = "right";
var left = "left";
	...
	if (mainAxis != null) {
		...
		switch (variation) {
			case start:
				...
				break;
			case end: offsets[mainAxis] = offsets[mainAxis] + (reference2[len] / 2 - element[len] / 2);
		}
	}
	return offsets;
}
...
var TargetSvgContainer = styled.g`
  cursor: ${(props) => props.trigger === "hover" || props.trigger?.includes("hover") ? "default" : "pointer"};
`;
var WithTooltipPure = ({ svg = !1, trigger = "click", closeOnOutsideClick = !1, placement = "top", modifiers = [
	{
		name: "preventOverflow",
		options: { padding: 8 }
	},
...
var DeprecatedPure = (props) => ((0, import_client_logger.deprecate)("WithTooltipPure is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."), import_react.createElement(WithTooltipPure, {
