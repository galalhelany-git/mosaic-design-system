import { r as __require$1 } from "./rolldown-runtime-B-lAHAz2.js";
import { t as require_client_logger } from "./storybook_internal_client-logger.js";
import { t as require_preview_errors } from "./storybook_internal_preview-errors.js";
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-IMSF75WX.js
...
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-3LY4VQVK.js
...
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-NZMVUW5T.js
function noop() {}
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-Z3B64JMR.js
...
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-7PIQR4A3.js
...
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-YX25HBUE.js
...
var inferControl = (argType, name, matchers) => {
	...
	if (type) {
		if (matchers.color && matchers.color.test(name)) {
			...
			controlType !== "enum" && import_client_logger.logger.warn(`Addon controls: Control of type color only supports string, received "${controlType}" instead`);
		}
		if (matchers.date && matchers.date.test(name)) return { control: { type: "date" } };
		switch (type.name) {
			case "array": return { control: { type: "object" } };
			case "boolean": return { control: { type: "boolean" } };
			case "string": return { control: { type: "text" } };
			case "number": return { control: { type: "number" } };
			case "enum": {
				let { value } = type;
				return {
					control: { type: value?.length <= 5 ? "radio" : "select" },
					options: value
				};
			}
			case "function":
			case "symbol": return null;
			default: return { control: { type: options ? "select" : "object" } };
		}
	}
};
var inferControls = (context) => {
	...
	return combineParameters(mapValues(filteredArgTypes, (argType, name) => argType?.type && inferControl(argType, name.toString(), matchers)), filteredArgTypes);
};
...
var inferType = (value, name, visited, cache) => {
	...
	switch (type) {
		...
		case "number":
		case "function":
		case "symbol": return { name: type };
	}
	if (value) {
		if (cache.has(value)) return cache.get(value);
		if (visited.has(value)) return import_client_logger.logger.warn(dedent`
      ...
      `), {
		...
		return Array.isArray(value) ? result = {
			name: "array",
			value: value.length > 0 ? inferType(value[0], name, visited, cache) : {
				name: "other",
				value: "unknown"
			}
		} : result = {
			name: "object",
			value: mapValues(value, (field) => inferType(field, name, visited, cache))
		}, visited.delete(value), cache.set(value, result), result;
	}
	return {
		name: "object",
		value: {}
...
var inferArgTypes = (context) => {
	let { id, argTypes: userArgTypes = {}, initialArgs = {} } = context, cache = /* @__PURE__ */ new Map();
	return combineParameters(Object.fromEntries(Object.entries(initialArgs).filter(([key]) => !userArgTypes[key]?.type).map(([key, arg]) => [key, {
		name: key,
		type: inferType(arg, `${id}.${key}`, /* @__PURE__ */ new Set(), cache)
	}])), mapValues(userArgTypes, (argType, key) => ({ name: key })), userArgTypes);
};
inferArgTypes.secondPass = !0;
function mergeServiceArgTypes({ payload, storyId, parameters, initialArgs, customArgTypes }) {
	return inferControls({
		argTypes: inferArgTypes({
			id: storyId,
			argTypes: combineParameters(payload.argTypes ?? {}, customArgTypes ?? {}),
...
function getServiceSubcomponentArgTypes(payload) {
	return Object.fromEntries(Object.entries(payload.subcomponents ?? {}).flatMap(([name, subcomponent]) => subcomponent.argTypes ? [[name, subcomponent.argTypes]] : []));
}
//#endregion
//#region ../../node_modules/.pnpm/storybook@10.6.0_@types+react@19.3.0_prettier@3.9.6_react@19.3.0/node_modules/storybook/dist/_browser-chunks/chunk-RDNWKK3U.js
var import_preview_errors = require_preview_errors();
var require_dist = __commonJS({ "../../node_modules/jsdoc-type-pratt-parser/dist/index.js"(exports, module) {
	(function(global, factory) {
		...
		let identifierStartRegex = /* @__PURE__ */ new RegExp("[$_\\p{ID_Start}]|\\\\u\\p{Hex_Digit}{4}|\\\\u\\{0*(?:\\p{Hex_Digit}{1,5}|10\\p{Hex_Digit}{4})\\}", "u"), identifierContinueRegex = /* @__PURE__ */ new RegExp("[$\\-\\p{ID_Continue}\\u200C\\u200D]|\\\\u\\p{Hex_Digit}{4}|\\\\u\\{0*(?:\\p{Hex_Digit}{1,5}|10\\p{Hex_Digit}{4})\\}", "u");
		...
		function composeParslet(options) {
			...
			return Object.defineProperty(parslet, "name", { value: options.name }), parslet;
		}
		...
		let genericParslet = composeParslet({
			...
			specialTypesParslet,
			notNullableParslet,
			createParameterListParslet({ allowTrailingComma: !0 }),
			genericParslet,
			unionParslet,
			optionalParslet
		];
			...
			return function(parser, precedence, left) {
				...
				switch (parsed.type) {
					...
					case "JsdocTypeSpecialNamePath":
						...
						break;
					default: throw new UnexpectedTypeError(parsed, "Expecting 'JsdocTypeName', 'JsdocTypeNumber', 'JsdocStringValue' or 'JsdocTypeSpecialNamePath'");
				}
			...
			return composeParslet({
				...
				parsePrefix: (parser) => {
					...
					if (parser.consume("StringValue")) result = {
						...
						specialType: type,
						meta: { quote: token.text[0] === "'" ? "single" : "double" }
					};
					else {
						let value = "", allowed = [
							"Identifier",
		...
		function createFunctionParslet({ allowNamedParameters, allowNoReturnType, allowWithoutParenthesis, allowNewAsFunctionKeyword }) {
			return composeParslet({
				...
				parsePrefix: (parser) => {
					...
					if (parser.consume(":")) result.returnType = parser.parseType(Precedence.PREFIX);
		...
		let symbolParslet = composeParslet({
			...
			parseInfix: (parser, left) => {
				...
				if (!parser.consume(")")) {
					if (result.element = assertNumberOrVariadicNameResult(parser.parseIntermediateType(Precedence.SYMBOL)), !parser.consume(")")) throw new Error("Symbol does not end after value");
				}
				return result;
			}
				...
				parsePrefix: (parser) => {
					...
					if (!parser.consume("}")) {
						...
						for (;;) {
							...
							if (parser.lexer.current.startOfLine) separator = "linebreak", parser.consume(",") || parser.consume(";");
							else if (parser.consume(",")) separator = "comma";
							else if (parser.consume(";")) separator = "semicolon";
							else break;
		...
		let keyOfParslet = composeParslet({
			...
			createTupleParslet({ allowQuestionMark: !1 }),
			createVariadicParslet({
				allowEnclosingBrackets: !1,
				allowPostfix: !1
			}),
		...
		function parse3(expression, mode) {
			switch (mode) {
				case "closure": return new Parser(closureGrammar, expression).parse();
				case "jsdoc": return new Parser(jsdocGrammar, expression).parse();
				case "typescript": return new Parser(typescriptGrammar, expression).parse();
			}
		}
			...
			return {
				...
				JsdocTypeNamePath: (result, transform2) => {
					...
					switch (result.pathType) {
						...
						case "instance": return `${left}#${right}`;
						case "property": return `${left}.${right}`;
						case "property-brackets": return `${left}[${right}]`;
					}
				},
...
` : "")}}`;
		...
		function getMemberType(type) {
			switch (type) {
				case "inner": return "INNER_MEMBER";
				case "instance": return "INSTANCE_MEMBER";
				case "property": return "MEMBER";
				case "property-brackets": return "MEMBER";
			}
		}
		...
		function _traverse(node, parentNode, property, onEnter, onLeave) {
			...
			for (let key of keysToVisit) {
				let value = node[key];
				if (value !== void 0) if (Array.isArray(value)) for (let element of value) _traverse(element, node, key, onEnter, onLeave);
				else _traverse(value, node, key, onEnter, onLeave);
			}
...
var convertSig = (type) => {
	switch (type.type) {
		...
		default: throw new import_preview_errors.UnknownArgTypesError({
			type,
			language: "Flow"
		});
	}
...
var convert = (type) => {
	...
	switch (typeof raw < "u" && (base.raw = raw), type.name) {
		...
		case "union": return type.elements?.every(isLiteral) ? {
			...base,
			name: "enum",
...
var isNull = (type) => type.name === "null";
...
var convert3 = (type) => {
	...
	switch (typeof raw < "u" && (base.raw = raw), type.name) {
		...
		case "union": {
			...
			return nonUndefinedElements.some(isLiteral2) && nonUndefinedElements.every((element) => isLiteral2(element) || isNull(element)) ? {
				...base,
				name: "enum",
				value: nonUndefinedElements.map((element) => isLiteral2(element) ? parseLiteral(element.value) : null)
			} : {
				...base,
				name,
				value: type.elements.map(convert3)
...
function getParser4({ startLine = 0, fence = "```", spacing = "compact", markers = Markers, tokenizers = [
	...
	let parseSource = getParser2({
		startLine,
		markers
	}), parseBlock = getParser({ fence }), parseSpec = getParser3({ tokenizers }), joinDescription = getJoiner2(spacing);
	return function(source) {
		let blocks = [];
...
function extractJsDocTags(ast, tags) {
	...
	for (let tagSpec of ast.tags) if (!(tags !== void 0 && !tags.includes(tagSpec.tag))) if (tagSpec.tag === "ignore") {
		...
		case "argument": {
			...
			paramTag != null && (extractedTags.params ??= [], extractedTags.params.push(paramTag));
			break;
		}
		case "deprecated": {
...
function joinNameAndDescription(name, desc) {
	return normaliseDescription(name === "" ? desc : `${name} ${desc}`);
}
...
function createType(type) {
	...
	switch (type.name) {
		case "union": return generateUnion(type);
		case "signature": return generateSignature(type);
		default: return generateDefault(type);
	}
}
...
function createType2({ tsType, required }) {
	...
	return required || (typeName = typeName.replace(" | undefined", "")), createSummaryValue([
		...
		"Record",
		"signature"
	].includes(tsType.name) ? tsType.raw : typeName);
}
...
function isStringValued(type) {
	return type ? type.name === "string" ? !0 : type.name === "enum" ? Array.isArray(type.value) && type.value.every(({ value: tv }) => typeof tv == "string" && tv[0] === "\"" && tv[tv.length - 1] === "\"") : !1 : !1;
}
...
var getPropDefFactory = (typeSystem) => {
	switch (typeSystem) {
		case "JavaScript": return javaScriptFactory;
		case "TypeScript": return tsFactory;
		case "Flow": return flowFactory;
...
var enhanceArgTypes = (context) => {
	let { component, argTypes: userArgTypes, parameters: { docs = {} } } = context, { extractArgTypes } = docs;
...
var SourceType = /* @__PURE__ */ ((SourceType2) => (SourceType2.AUTO = "auto", SourceType2.CODE = "code", SourceType2.DYNAMIC = "dynamic", SourceType2))(SourceType || {});
function shouldSkipStoryDocsEmit(parameters) {
	let sourceParams = parameters?.docs?.source, isArgsStory = parameters?.__isArgsStory;
	return parameters?.__isPortableStory ? !0 : sourceParams?.type === "dynamic" ? !1 : !isArgsStory || sourceParams?.code !== void 0 || sourceParams?.type === "code";
}
...
//#endregion
export { mergeServiceArgTypes as A, __export as B, isValidDocgenSection as C, shouldWaitForServiceSnippet as D, shouldSkipStoryDocsEmit as E, toMerged as F, __toESM as H, isEqual as I, isPlainObject as L, mergeWith as M, omit as N, str as O, pick as P, dedent as R, isTooLongForTypeSummary as S, parseJsDoc as T, __require as V, getDocgenDescription as _, PARAM_KEY as a, isDefaultValueBlacklisted as b, TypeSystem as c, createSummaryValue as d, enhanceArgTypes as f, extractComponentSectionObject as g, extractComponentSectionArray as h, PANEL_ID as i, mapValues as j, getServiceSubcomponentArgTypes as k, anchorBlockIdFromId as l, extractComponentProps as m, MAX_DEFAULT_VALUE_SUMMARY_LENGTH as n, SNIPPET_RENDERED as o, extractComponentDescription as p, MAX_TYPE_SUMMARY_LENGTH as r, SourceType as s, ADDON_ID as t, convert4 as u, getDocgenSection as v, normalizeNewlines as w, isTooLongForDefaultValueSummary as x, hasDocgen as y, __commonJS as z };
